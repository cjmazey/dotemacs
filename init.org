...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-directory "~/.emacs.d/private"
          org-agenda-files '("~/.emacs.d/private/agenda.org")
          org-archive-location "~/.emacs.d/private/archive.org::"
          org-default-notes-file "~/.emacs.d/private/notes.org"
          org-refile-use-outline-path t
          org-capture-templates '(("t" "Task" entry
                                   (file+headline "~/.emacs.d/private/agenda.org" "Tasks")
                                   "* TODO %?\n  %u\n  %a")
                                  ("p" "Poem" entry
                                   (file "~/.emacs.d/private/poems.org")
                                   "* UNPUBLISHED %?\n\n%i\n\n%U" :empty-lines 1))
